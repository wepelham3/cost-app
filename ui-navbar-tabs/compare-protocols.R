             ...
             fluidRow(
               column(4, offset= 0.5,
                 ...
                 wellPanel(
                   ...
                   fileInput('file.protocol1', 'Choose protocol file to upload',
                             accept ='.rds'),
               ...
               column(4, offset= 0.5,
                  br(),
                  wellPanel(              
                    fileInput('file.protocol2', 'Choose protocol file to upload',
                              accept ='.rds'),
               ...
               column(4, offset= 0.5,
                 ...
                 wellPanel(   
                    fileInput('file.protocol3', 'Choose protocol file to upload',
                           accept ='.rds'),
